const platforms = [
    ...
    { 
        ...
        formatExample: "https://example.com/mts-telegram.jpg"
    },
    { 
        id: 23, 
        name: "OZON", 
...
const briefs = {
    traffic: {
        ...
        description: "Уважаемые коллеги, в рамках маркетинговой кампании по продвижению нового инвестиционного продукта ВТБ необходимо сформировать медиаплан, направленный на генерацию трафика на сайт. Основные KPI: количество сеансов - не менее 2 000 000 при бюджете 15 000 000 рублей. Просим учесть показатели эффективности площадок при формировании плана.",
        tasks: [
            { 
                id: 1,
    ...
    reach: {
        ...
        description: "Уважаемые коллеги, в рамках кампании по повышению осведомленности о бренде ВТБ необходимо сформировать медиаплан с максимальным охватом целевой аудитории. Основные KPI: охват - не менее 20 000 000 пользователей при бюджете 15 000 000 рублей. Просим учитывать частоту контактов при выборе площадок.",
        tasks: [
            { 
                id: 1,
                description: "Реализовать бюджет (15 млн ₽)", 
    ...
    brandformance: {
        title: "Brandformance",
        description: "Уважаемые коллеги, в рамках комплексной кампании по продвижению бренда ВТБ необходимо сформировать медиаплан, сочетающий цели брендинга и performance. Требуется достичь всех KPI одновременно: охват, клики, конверсии при оптимальных ценовых показателях. Бюджет: 15 000 000 рублей.",
        tasks: [
            { 
                id: 1,
                description: "Реализовать бюджет (15 млн ₽)", 
...
const randomEventsList = [
    ...
    },
    {
        ...
        content: `<div class="random-event-email">
            <div class="email-header">
                <span>От: Финансовый отдел VTB</span>
        ...
        mediaplan.innerHTML = `
            ...
            <div class="platforms-container">
                ${selectedPlatforms.map(platform => {
                    ...
                    const cpc = clicks > 0 ? Math.round(platform.budget / clicks * 100) / 100 : 0;
                    const cpvisit = sessions > 0 ? Math.round(platform.budget / sessions * 100) / 100 : 0;
                    const cpa = conversions > 0 ? Math.round(platform.budget / conversions * 100) / 100 : 0;
