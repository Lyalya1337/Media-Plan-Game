    ...
    reach: {
        ...
        tasks: [
            ...
            { 
                ...
                icon: "fas fa-tag",
                hint: "Коллеги, мы посмотрели медиаплан и необходимо внести следующие доработки: снизьте стоимость 1000 единиц охвата, выбирая площадки с хорошим соотношением цены и охвата (например, VK - CPM 270₽)",
                metrics: ["avgCPT"]
            },
            { 
                id: 4,
                ...
                icon: "fas fa-tag",
                hint: "Коллеги, мы посмотрели медиаплан и необходимо внести следующие доработки: снизьте средний CPM, комбинируя дорогие и дешевые площадки (например, добавьте VK - 270₽)",
                metrics: ["avgCPM"]
            },
            { 
                id: 5,
